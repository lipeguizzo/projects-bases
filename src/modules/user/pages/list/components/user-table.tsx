...
export function UserTable({
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      headerName: 'Gênero',
      width: 150,
      renderCell: (params) => <DataTableColumnGender gender={params.value} />,
    },
    {
      field: 'phone',
      headerName: 'Telefone',
      width: 150,
      renderCell: (params) => <DataTableColumnPhone value={params.value} />,
    },
    {
      field: 'roleId',
      headerName: 'Perfil',
      width: 150,
      renderCell: (params) => <DataTableColumnRole role={params.row.role} />,
    },
    {
